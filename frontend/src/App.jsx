          ...
          <div className="h-96">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data="{history}">
                ...
                <Tooltip contentStyle={{ backgroundColor: '#020617', borderColor: '#1e293b', color: '#34d399' }} itemStyle={{}} />
                <Line type="monotone" dataKey="value" stroke="#34d399" strokeWidth={3} dot={{ fill: '#020617', stroke: '#34d399', strokeWidth: 2, r: 4 }} activeDot={{ r: 6, stroke: '#34d399' }} />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </div>
